...
impl Component for MapCellComponent {
    ...
    fn view(&self, ctx: &Context<Self>) -> Html {
        let img_path = vec!["game-unit/0.png", "game-unit/1.png", "game-unit/2.png", "game-unit/3.png", "game-unit/4.png", "game-unit/5.png"];
        let link = ctx.link();
        html! {
            <div class="cell">
...
impl Component for MapTableComponent {
    ...
    fn create(_ctx: &Context<Self>) -> Self {
        Self { children: _ctx.props().children.clone() }
    }
